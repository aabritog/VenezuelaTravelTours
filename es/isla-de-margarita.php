...
<html>
	<head>
		<title>Venezuela Travel Tours - Isla de Margarita</title>
			...
			<!--Slider-->
		        ...
		        <div class="carousel-inner" role="listbox">
		            <div class="item active">
                        <img src="images/slide/Margarita03.jpg" width="100%" height="1200px" alt="" />
                        <div class="carousel-caption">
		                    <h3>Isla de Coche</h3>
                        </div>
                    </div>
                    <div class="item">
                        <img src="images/slide/Margarita02.jpg" width="100%" height="1200px" alt="" />
                        <div class="carousel-caption">
		                    <h3>Basílica Menor de la Virgen del Valle</h3>
                        </div>
                    </div>
		            <div class="item">
		                <img src="images/slide/Margarita04.jpg" width="100%" height="1200px" alt="" />
		                <div class="carousel-caption">
		                    <h3>Castillo de Pampatar</h3>
		                </div>
		            </div>
		            <div class="item">
		                <img src="images/slide/Margarita05.jpg" width="100%" height="1200px" alt="" />
		                <div class="carousel-caption">
		                    <h3>Castillo de Pampatar</h3>
		                </div>
		            </div>
		            <div class="item">
		                <img src="images/slide/Margarita06.jpg" width="100%" height="1200px" alt="" />
		                <div class="carousel-caption">
		                    <h3>&nbsp;</h3>
		                </div>
		            </div>
		            <div class="item">
		                <img src="images/slide/Margarita09.jpg" width="100%" height="1200px" alt="" />
		                <div class="carousel-caption">
		                    <h3>Laguna de la Restinga</h3>
		                </div>
		            </div>
		            <div class="item">
		                <img src="images/slide/Margarita10.jpg" width="100%" height="1200px" alt="" />
		                <div class="carousel-caption">
		                    <h3>Laguna de la Restinga</h3>
		                </div>
		            </div>	
		            <div class="item">
		                <img src="images/slide/Margarita07.jpg" width="100%" height="1200px" alt="" />
		                <div class="carousel-caption">
