			...
			<!--Slider-->
		        ...
		        <div style="height: 600px !important;" class="carousel-inner" role="listbox">
		            <div class="item active">
                        <img src="images/slide/OrinocoDelta02.jpg" width="100%" height="700px" alt="Orinoco Delta" />
                        <div class="carousel-caption">
		                    <h3></h3>
                    </div>
                    </div>
                    <div class="item">
                        <img src="images/slide/OrinocoDelta04.jpg" width="100%" height="700px" alt="Delta del Orinoco" />
                        <div class="carousel-caption">
		                    <h3></h3>
                        </div>
                    </div>
		            <div class="item">
		                <img src="images/slide/OrinocoDelta06.jpg" width="100%" height="700px" alt="Rio Orinoco" />
		                <div class="carousel-caption">
		                    <h3></h3>
		                </div>
		            </div>
		            ...
		            <div class="item">
		                <img src="images/slide/OrinocoDelta09.jpg" width="100%" height="700px" alt="Orinoco" />
		                <div class="carousel-caption">
		                    <h3></h3>
		                </div>
		            </div>
		            <div class="item">
		                <img src="images/slide/OrinocoDelta11.jpg" width="100%" height="700px" alt="Delta Venezuela" />
		                <div class="carousel-caption">
		                    <h3></h3>
		                </div>
		            </div>	
		            <div class="item">
		                <img src="images/slide/OrinocoDelta07.jpg" width="100%" height="700px" alt="Oricono Delta Indio" />
		                <div class="carousel-caption">
		                    <h3></h3>
		                </div>
		            </div>			            	         
