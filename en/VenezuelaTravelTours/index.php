	...
	<body class="homepage">
		...
		<div id="page-wrapper">
			...
			<!-- Banner -->
				<section id="banner">
					<header>
						<h1>Only One Travel takes you to know the most exotic destinations in the world...</h1>
						<!--<p>
					...
					<section id="features" class="container special">
						...
						<div class="row">
							<article class="4u 12u(mobile) special">
								...
								<header>
									<h3><a href="salto-angel.php">Angel Falls</a></h3>
								</header>
								<p>
									Angel Falls (Spanish: Salto Ángel; Pemon language: Kerepakupai Vená, meaning "waterfall of the deepest place", 
									or Parakupá Vená, meaning "the fall from the highest point") is a waterfall in Venezuela. 
						...
						<div class="row">
							<article class="4u 12u(mobile) special">
								...
								<header>
									<h3><a href="orinoco-delta.php">Orinoco Delta</a></h3>
								</header>
								<p>
									Orinoco Delta is the delta is a vast river delta of the Orinoco River, one of the largest in the world. Its extension made
									think early Spanish explorers was a sea. It is considered a place of great natural wealth for the great variety of flora and fauna.
							...
							<article class="4u 12u(mobile) special">
								...
								<p>
									...
									north of the peninsula of Araya Sucre state. Along with the islands of Coche and Cubagua , it is the only island state of Venezuela , called Nueva Esparta. The island served...
								</p>
							</article>
							<article class="4u 12u(mobile) special">
