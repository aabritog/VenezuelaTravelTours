...
<html>
	<head>
		<title>Venezuela Travel Tours - The Roques</title>
	...
	<body style="overflow-x:hidden !important;" class="homepage">
		...
		<article>
			...
			<div class="row featurette">
	                <div class="col-md-9">
	                    ...
	                    <p> The climate is warm and dry, with average annual temperature of 27.3 ° C, 2 in July and August, reaches a maximum of 34 °, and between September and January are presented occasional rain, with relative humidity 83% annually. Rainfall is 256.6 mm / year; minimum 6.6 mm (April) and maximum 52.2 mm (November).</p>
	                </div>
	                <div class="col-md-3">
		...
		<article>
			...
			<p>
				oundtrip airfare from Higuerote, assistance to get to Los Roques, small boat excursion to a nearby cay. Awnings and beach chairs. Lunch at the beach cooler with ice, water, sodas and beer. Snorkeling equipment and beach games. Refreshments and bilingual guides. Return to late afternoon.
			</p>
			<p>
				<i>From monday to sunday.</i>
			</p>
			<p><strong>• FULL DAY IN CATAMARAN</strong></p>
			<p> 
			...
			<p>
			<p>
				<i>From monday to friday or saturday and sunday.</i>
			</p>
			<p><strong>• PHOSTEL TYPE STANDARD (CHEZ JUDITH, THE BOTUTO)</strong></p>
			<p>
			...
			<p>
				<i>2 days and 1 night or 3 days and 2 nights.</i>
			</p>
			<p><strong>• HOSTEL TYPE INTERMEDIATE (NEARBY CAY LUNA, GUARIPETE)</strong></p>
			<p> 
			...
			<p><strong>• HOSTEL TYPE SUPERIOR (MACANAO, ARRECIFE)</strong></p>
			<p>
			...
			<p><strong>• HOSTEL TYPE LUXURY, (NATURA VIVA, MEDITERRANEO)</strong></p>
			<p>
			...
			<p>
				<i>2 days and 1 night or 3 days y 2 nights.</i>
			</p>
