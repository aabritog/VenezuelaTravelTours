...
<!--				<section id="banner">
		...
		<div class="container">
			<div class="panel panel-warning">
				<div class="panel-heading">
			    	<h2 class="panel-title">
			    		<a data-toggle="collapse" data-parent="#accordion" href="#primerCollapse" aria-expanded="true" aria-controls="segundoCollapse">Salto Angel</a>
			  		</h2>
			  	</div>
			...
			<div class="panel panel-warning">
				<div class="panel-heading">
			    	<h2 class="panel-title">
			    		<a data-toggle="collapse" data-parent="#accordion" href="#segundoCollapse" aria-expanded="true" aria-controls="segundoCollapse">Turismo</a>
			  		</h2>
			  	</div>
...
<!--
		...
		<div class="container">			
			<div class="panel panel-warning">
				<div class="panel-heading">
			    	<h2 class="panel-title">
			    		<a data-toggle="collapse" data-parent="#accordion" href="#tercerCollapse" aria-expanded="true" aria-controls="segundoCollapse">Itinerario del paquete</a>
			  		</h2>			    
			  	</div>
